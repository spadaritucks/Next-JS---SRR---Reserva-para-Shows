...
export async function checkoutAction(formData: FormData) {
  ...
  const reservedSpotRaw = (await cookieStore).get("spots")?.value;
  ...
  const eventId = (await cookieStore).get("eventId")?.value;
  ...
  (await cookieStore).set("spots", "");
  (await cookieStore).set("eventId", "");
  redirect("/");
}
